...
> Design notes for **rs-exponential-backoff** — a runnable rust example that Tiny, dependency-free exponential-backoff delay calculator with full jitter.
...
- **Feature code** — the actual task: backoff.
